...
- Подтверждено, что ингибиторы PAPD5 (BCH001 и RG7834) изменяют транскриптом iPSC-клеток с мутацией PARN на уровне экспрессии генов
  
![Тепловая карта всех значимых генов](results/heatmap_all_significant.png)
